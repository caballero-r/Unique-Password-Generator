...
function passwordLength() {
	...
	password_length = window.prompt(
		'Choose the desired length of your password. Please choose from a minimum of 8 to maximum of 128 characters in length.'
	)
...
function confirmCharacters() {
	var yes_lower_characters = confirm(
		'Do you want to have lowercase characters in your password? Click: "Okay" for "Yes" or Click: "Cancel" for "No"'
	)
	var yes_upper_characters = confirm(
		'Do you want to have uppercase characters in your password? Click: "Okay" for "Yes" or Click: "Cancel" for "No"'
	)
	var yes_special_characters = confirm(
		'Do you want to have special characters in your password? Click: "Okay" for "Yes" or Click: "Cancel" for "No"'
	)
	var yes_numbers = confirm(
		'Do you want to have numbers in your password? Click: "Okay" for "Yes" or Click: "Cancel" for "No"'
	)

	if (
		!yes_lower_characters &&
		!yes_upper_characters &&
		!yes_special_characters &&
		!yes_numbers
	) {
		window.alert(
			'invalid entry, please choose to include at least one set of characters in your password'
		)
